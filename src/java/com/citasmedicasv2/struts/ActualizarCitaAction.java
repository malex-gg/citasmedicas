 ...
 * @author Malex
 */
public class ActualizarCitaAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        //citas.setFechaCita(request.getParameter("datepicker"));
        //citas.setFechaCita(Date.parse(request.getParameter("datepicker")));
        citas.setMedicoCita(request.getParameter("medicocita"));
        
        String serv = servicio.actualizarCitas(citas);
