 ...
 * @author Malex
 */
public class LoginMedicoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        Medico medico = servicio.obtenerMedico(request.getParameter("cedulamedico"));
        
        if (medico != null) {
            if (request.getParameter("passwordmedico").equals(medico.getContraseniaMedico())) {
