 ...
 * @author Malex
 */
public class EliminarHistorialAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        historial.setCedulaPacienteHistorial(request.getParameter("cedulap"));
        
        String serv = servicio.eliminarHistorial(historial);
